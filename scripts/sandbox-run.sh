...
echo ""
echo "At the API key prompt: paste your key and press Enter."
echo "  (Characters will show as you type — that is normal.)"
echo ""
echo "Try both modes:"
echo "  2 = Guided (y/Enter=yes, n=no before each step)"
...
echo "=========================================="
echo ""
echo "Sandbox files written (Auto or Guided with yes):"
